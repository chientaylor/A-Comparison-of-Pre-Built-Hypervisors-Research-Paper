...
while [ "$PLATBOOL" != '0' ] && [ "$PLATBOOL" != '1' ] && [ "$PLATBOOL" != '2' ] && [ "$PLATBOOL" != '3' ] && [ "$PLATBOOL" != '4' ]; do
echo "What Platform?"
echo "0: Baremetal"
echo "1: ProxMox"
echo "2: XenServer"
...
# Put in place to prevent SSH timeouts during long periods of non-interaction
